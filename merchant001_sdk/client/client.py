...
class Client(BaseClient):
    ...
    async def get_payment_method_rate(
        ...
        result: responses.RawResult | responses.ErrorResult = await self._request(  # type: ignore
            ...
            f"v1/rate/",
            return_raw=True,
            params={"method": payment_method, "direction": direction},
            success_status=(http.HTTPStatus.OK,),
        )
    ...
    async def get_withdraw_by_id(
        ...
        result: responses.RawResult | responses.ErrorResult = await self._request(  # type: ignore
            "GET",
            f"v1/withdraw/merchant/{transaction_id}",
            return_raw=True,
            success_status=(http.HTTPStatus.OK,),
        )
    ...
    @sync_or_async()
    async def get_available_withdraw(
            self,
    ) -> dict | responses.ErrorResult:
        """get_available_withdraw.
        ...
        result: responses.RawResult | responses.ErrorResult = await self._request(  # type: ignore
            "GET",
            f"v2/payment-method/merchant/available-withdraw",
            return_raw=True,
            success_status=(http.HTTPStatus.OK,),
        )
    ...
    @sync_or_async()
    async def get_merchant_by_invoice_id(
            self,
            invoice_id: str,
    ) -> dict | responses.ErrorResult:
        """get_merchant_by_invoice_id.
        ...
        result: responses.RawResult | responses.ErrorResult = await self._request(  # type: ignore
            "GET",
            f"v1/transaction/merchant/invoiceid/{invoice_id}",
            return_raw=True,
            success_status=(http.HTTPStatus.OK,),
        )
